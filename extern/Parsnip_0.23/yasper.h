...
inline bool operator==(const ptr<X> &lptr, const ptr<Y> &rptr)
{
    return lptr.GetRawPointer() == rptr.GetRawPointer();
}

template <typename X, typename Y>
inline bool operator==(const ptr<X> &lptr, Y *raw)
{
    return lptr.GetRawPointer() == raw;
}

template <typename X>
inline bool operator==(const ptr<X> &lptr, long num)
{
...
template <typename X>
inline bool operator&&(const ptr<X> &lptr, bool rval)
{
    return lptr.IsValid() && rval;
}

template <typename X>
inline bool operator&&(bool lval, const ptr<X> &rptr)
{
...
template <typename X>
inline bool operator!(const ptr<X> &p)
{
    return (!p.IsValid());
}
...
template <typename X, typename Y>
inline bool operator<(X *raw, const ptr<Y> &rptr)
{
